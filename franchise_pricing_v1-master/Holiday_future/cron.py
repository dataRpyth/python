...
from Holiday_future.configuration import JobConfig
from common.alert.alert import PricingAlert
from common.util.utils import *
from Holiday_future.holiday_future_job_runner import HolidayFutureJob
...
if __name__ == "__main__":
    ...
    job = HolidayFutureJob(job_config)
